                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <div className="flex items-center mt-1">
                    <span className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${
                      ...
                      {agent.isActive ? "Puede iniciar sesión" : "No puede iniciar sesión"}
                    </span>
                  </div>
                  {agent.lastLogin && (
                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Último acceso: {new Date(agent.lastLogin).toLocaleDateString('es-ES')}
                    </div>
                  )}
                </td>
                  ...
                  <div className="space-y-1">
                    ...
                    {agent.lockedUntil && new Date(agent.lockedUntil) > new Date() && (
                      <div className="text-xs text-red-600 dark:text-red-400">
                        🔒 Bloqueado hasta {new Date(agent.lockedUntil).toLocaleString('es-ES')}
                      </div>
                    )}
