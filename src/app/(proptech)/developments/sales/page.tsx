          ...
          <div className="relative p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="text-right">
                ...
                <p className="text-3xl font-extrabold mt-1">{filteredSummary.totalSales}</p>
              </div>
            </div>
            <p className="text-blue-100/80 text-xs font-medium">Ventas registradas</p>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden bg-gradient-to-br from-emerald-500 via-green-500 to-teal-600 text-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
          ...
          <div className="relative p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="text-right">
                <p className="text-emerald-100 text-xs font-semibold uppercase tracking-wide">Ingresos</p>
                <p className="text-2xl font-extrabold mt-1">${filteredSummary.totalRevenue.toLocaleString()}</p>
              </div>
            </div>
            <p className="text-emerald-100/80 text-xs font-medium">Ingresos totales</p>
          </div>
        </div>

        <div className="group relative overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-600 text-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
          <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
          <div className="relative p-5">
            <div className="flex items-center justify-between mb-3">
              <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm shadow-lg">
              ...
              <div className="text-right">
                <p className="text-indigo-100 text-xs font-semibold uppercase tracking-wide">Activas</p>
                <p className="text-3xl font-extrabold mt-1">{filteredSummary.activeSales}</p>
              </div>
            </div>
            <p className="text-indigo-100/80 text-xs font-medium">Ventas activas</p>
          </div>
        </div>

        <div className="group relative overflow-hidden bg-gradient-to-br from-teal-500 via-cyan-500 to-blue-600 text-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
          <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
          <div className="relative p-5">
            <div className="flex items-center justify-between mb-3">
              <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm shadow-lg">
              ...
              <div className="text-right">
                <p className="text-teal-100 text-xs font-semibold uppercase tracking-wide">Completadas</p>
                <p className="text-3xl font-extrabold mt-1">{filteredSummary.completedSales}</p>
              </div>
            </div>
            <p className="text-teal-100/80 text-xs font-medium">Ventas finalizadas</p>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden bg-gradient-to-br from-red-500 via-rose-500 to-pink-600 text-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
          ...
          <div className="relative p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="text-right">
                <p className="text-red-100 text-xs font-semibold uppercase tracking-wide">Vencidas</p>
                <p className="text-3xl font-extrabold mt-1">{filteredSummary.overduePayments}</p>
              </div>
            </div>
            <p className="text-red-100/80 text-xs font-medium">Cuotas vencidas</p>
          </div>
        </div>
      </div>
