          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 transition-all duration-200 shadow-sm hover:shadow-md sm:gap-3 sm:px-6 sm:py-3 sm:text-base"
              >
                <svg className="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
