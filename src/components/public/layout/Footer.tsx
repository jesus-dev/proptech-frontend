      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-800">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            <p className="text-gray-400 text-xs sm:text-sm text-center sm:text-left">© {currentYear} PropTech CRM. Todos los derechos reservados.</p>
            <div className="flex items-center space-x-4 sm:space-x-6">
              <span className="text-gray-400 text-xs sm:text-sm">Hecho con ❤️ en Paraguay</span>
            </div>
          </div>
        </div>
      </div>
