      ...
      <div className={`text-sm ${className}`}>
        ...
        {contact.email && (
          <div className="flex items-center gap-2">
            ...
            <span className="break-all text-base md:text-lg text-gray-700 dark:text-gray-300">{contact.email}</span>
          </div>
        )}
      </div>
    );
    ...
    <div className={`space-y-3 ${className}`}>
      ...
      {contact.website && (
        <div className="flex items-center gap-2">
          ...
          <a href={contact.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline dark:text-blue-400">
            {contact.website}
          </a>
        </div>
      )}
      ...
      {showSocial && (
        <div className="flex gap-3 pt-2">
          ...
          {('instagram' in contact) && contact.instagram && (
            <a 
          ...
          {('facebook' in contact) && contact.facebook && (
            <a 
